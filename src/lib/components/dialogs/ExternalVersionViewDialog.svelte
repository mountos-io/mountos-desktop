        ...
        <div class="grid gap-4 py-4">
          ...
          <details class="text-sm">
            ...
            <div class="grid gap-1.5 pt-2">
              <span class="inline-flex items-center gap-1"><Label for="external-version-inode">Inode number</Label><InfoTip text="**ls -i** shows a file's inode number. This skips Browse. mountOS looks up the file by inode number only." /></span>
